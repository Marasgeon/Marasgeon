clc; clear; close all;
%% ?? ??
l1 = 0.4; l2 = 0.4; l3 = 0.4; l4 = 0; l5 = 0.2+0.15; % ? arm? ????.
h1 = 0.05; h2 = 0.05; h3 = 0.05; h4 = 0.05; h5 = 0.05; % ? arm? ????.
m1 = 1.35; m2 = 1.35+1.3; m3 = 1.35+1.3; m4 = 1.3; m5 = 0.73+0.7; % ? arm? ????.
g = 9.806;

lc2 = l2/2; lc3 = l3/2; lc4 = l5/2; % ?????? arm? ?????? ??.
I2 = 1/12/2*m2*(h2^2+l2^2); I3 = 1/12/2*m3*(h3^2+l3^2); I4 = 1/12/2*m4*(h4^2+l5^2); % ? arm? ???????.
