...
hold on;
plot(t, desired_theta1, 'LineWidth', 2);
xlabel('Time (s)');
...
hold on;
plot(t, desired_theta2, 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Joint Angle (rad)');
title('Joint 2 Angle');
legend('Desired', 'Actual');
...
hold on;
plot(t, desired_theta3, 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Joint Angle (rad)');
title('Joint 3 Angle');
legend('Desired', 'Actual');
