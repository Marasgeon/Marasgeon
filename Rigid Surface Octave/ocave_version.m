...
friction_coeff = 15;  % Friction coefficient
damping_coeff = 10;  % Damping coefficient
...
% Define the constraint_surface and dynamics functions here (they remain unchanged).
% Constraint surface function
##function h = constraint_surface(q, A, B, w, phi)
##    theta1 = q(1);
##    theta2 = q(2);
